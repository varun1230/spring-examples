...
@RestController
@RequestMapping("/controller/rest1")
public class UsageOfRestController2 {
//	public String printMessage(@PathVariable("id") String id, HttpServletRequest request, HttpServletResponse response){	
	...
	@RequestMapping(value="/saveParty", method=RequestMethod.POST, produces="application/json")
	public @ResponseBody Employee saveParty(HttpServletRequest req ) {
		Employee e = new Employee();
//		e.setName(name);
//		e.setEmail(name+"@vstTech.com");
		return e;
